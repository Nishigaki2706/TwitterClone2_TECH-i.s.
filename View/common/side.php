<div class="side">
            <div class="side-inner">
                <ul class="navflex-column">
                    ...
                    <li class="nav-item"><a href="notification.php" class="nav-link"><img src="<?php echo HOME_URL;?>/View/img/icon-notification.svg" alt=""></a></li>
                    ...
                    <li class="nav-item my-icon"><img src="<?php echo htmlspecialchars($view_user['image_path']);?>" alt="" class="js-popover" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="right"data-bs-content="<a href='pofile.php'>プロフィール</a><br><a href='sign=out.php'>ログアウト</a>" data-bs-html="true"></li>
